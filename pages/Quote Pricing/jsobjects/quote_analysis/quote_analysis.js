export default {
   ...
   storeValue('current_quote', current_quote, false);
	...
	update_perils: (risk) => {
		...
		upd_risk.perils['flood_depth_20'] = qaFloodDepth20.text;
		upd_risk.perils['flood_depth_50'] = qaFloodDepth50.text;
		upd_risk.perils['flood_depth_100'] = qaFloodDepth100.text;
		upd_risk.perils['flood_depth_200'] = qaFloodDepth200.text;
		upd_risk.perils['flood_depth_500'] = qaFloodDepth500.text;
		upd_risk.perils['flood_depth_1000'] = qaFloodDepth1000.text;
		upd_risk.perils['flood_depth_extreme'] = qaFloodDepthExtreme.text;
		upd_risk.perils['flood_ari_gl'] = qaFloodARIGL.text;
		upd_risk.perils['flood_ari_gl1m'] = qaFloodARIGL1m.text;
		upd_risk.perils['flood_ari_gl2m'] = qaFloodARIGL2m.text;
		upd_risk.perils['riverine_percentage'] = qaRiverine.text;
		upd_risk.perils['overland_percentage'] = qaOverland.text;
		upd_risk.perils['elevation'] = qaElevation.text;
		upd_risk.perils['ga_catchment'] = qaCatchment.text;
		upd_risk.perils['resolution'] = qaResolution.text;
		upd_risk.perils['levee_information'] = qalevee.text;
		upd_risk.perils['notes_id1'] =qaNotes1.text;
		upd_risk.perils['notes_id2'] = qaNotes2.text;
		upd_risk.perils['wfm_coverage_flag'] = qaWFM.text;
		upd_risk.perils['fdi'] = qaFDI.text;
		upd_risk.perils['veg_type'] = qaVegType.text;
		upd_risk.perils['distance'] = qaDistance.text;
		upd_risk.perils['bushfire_attack_level'] = qaBAL.text;
		upd_risk.perils['bal_category'] = qaBALCategory.text;
		upd_risk.perils['surroundedness'] = qaSurroundedness.text;
		upd_risk.perils['windgust_5yr_ari'] = qaWindgust5yr.text;
		upd_risk.perils['windgust_10yr_ari'] = qaWindgust10yr.text;
		upd_risk.perils['windgust_25yr_ari'] = qaWindgust25yr.text;
		upd_risk.perils['windgust_50yr_ari'] = qaWindgust50yr.text;
		upd_risk.perils['windgust_100yr_ari'] = qaWindgust100yr.text;
		upd_risk.perils['windgust_250yr_ari'] = qaWindgust250yr.text;
		upd_risk.perils['windgust_500yr_ari'] = qaWindgust500yr.text;
		upd_risk.perils['windgust_1000yr_ari'] = qaWindgust1000yr.text;
		upd_risk.perils['adjusted'] = qaAdjusted.text;
		upd_risk.perils['sts_risk'] = qaSTSRisk.text;
		upd_risk.perils['ot'] = qaOT.text;
		upd_risk.perils['radar'] = qaRadar.text;
		upd_risk.perils['reanalysis'] = qaReanalysis.text;
		upd_risk.perils['obs_size_100'] = qaOBSSize.text;
		upd_risk.perils['dist_coast'] = qaDistCoast.text;
		upd_risk.perils['terrain_location'] = qaTerrainLocation.text;
		upd_risk.perils['terrain_resolution'] = qaTerrainResolution.text;
		upd_risk.perils['remoteness_area'] = qaRemotenessArea.text;
